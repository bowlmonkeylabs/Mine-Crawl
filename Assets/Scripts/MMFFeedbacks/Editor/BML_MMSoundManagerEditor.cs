...
using BML.Scripts.MMFFeedbacks;
using MoreMountains.Tools;
using UnityEditor;
using UnityEngine;

namespace BML.Script.MMFFeedbacks.Editor
{
    /// <summary>
    /// Custom editor for the MMSoundManager, used to display custom track controls
    /// </summary>
    #if UNITY_EDITOR
    [CustomEditor(typeof(BML_MMSoundManager))]
    [CanEditMultipleObjects]
    public class BML_MMSoundManagerEditor : UnityEditor.Editor
    {
        ...
        protected BML_MMSoundManager _mmSoundManager;
        ...
        {
            _settingsSO = (target as BML_MMSoundManager).settingsSo;
            _mmSoundManager = target as BML_MMSoundManager;
            ...
            {
                DrawTrack("Master Track", BML_MMSoundManager.Instance.settingsSo.Settings.MasterOn, MMSoundManager.MMSoundManagerTracks.Master, _masterColorMute, _masterColorUnmute, _masterColorPause, _masterColorStop, _masterColorPlay, _masterColorFree);
                DrawTrack("Music Track", BML_MMSoundManager.Instance.settingsSo.Settings.MusicOn, MMSoundManager.MMSoundManagerTracks.Music, _musicColorMute, _musicColorUnmute, _musicColorPause, _musicColorStop, _musicColorPlay, _musicColorFree);
                DrawTrack("SFX Track", BML_MMSoundManager.Instance.settingsSo.Settings.SfxOn, MMSoundManager.MMSoundManagerTracks.Sfx, _sfxColorMute, _sfxColorUnmute, _sfxColorPause, _sfxColorStop, _sfxColorPlay, _sfxColorFree);
                DrawTrack("UI Track", BML_MMSoundManager.Instance.settingsSo.Settings.UIOn, MMSoundManager.MMSoundManagerTracks.UI, _uiColorMute, _uiColorUnmute, _uiColorPause, _uiColorStop, _uiColorPlay, _uiColorFree);
                DrawSaveLoadButtons();
            }
        }
        ...
        protected virtual void DrawTrack(string title, bool mute, MMSoundManager.MMSoundManagerTracks track, Color muteColor, Color unmuteColor, Color pauseColor, Color stopColor, Color playColor, Color freeColor)
        {
            ...
            switch (track)
            {
                case MMSoundManager.MMSoundManagerTracks.Master:
                    ...
                    if (newVolume != _masterVolume) { BML_MMSoundManager.Instance.settingsSo.SetTrackVolume(MMSoundManager.MMSoundManagerTracks.Master, newVolume); }
                    break;
                case MMSoundManager.MMSoundManagerTracks.Music:
                    ...
                    if (newVolume != _musicVolume) { BML_MMSoundManager.Instance.settingsSo.SetTrackVolume(MMSoundManager.MMSoundManagerTracks.Music, newVolume); }
                    break;
                case MMSoundManager.MMSoundManagerTracks.Sfx:
                    ...
                    if (newVolume != _sfxVolume) { BML_MMSoundManager.Instance.settingsSo.SetTrackVolume(MMSoundManager.MMSoundManagerTracks.Sfx, newVolume); }
                    break;
                case MMSoundManager.MMSoundManagerTracks.UI:
                    ...
                    if (newVolume != _uiVolume) { BML_MMSoundManager.Instance.settingsSo.SetTrackVolume(MMSoundManager.MMSoundManagerTracks.UI, newVolume); }
                    break;
            }
